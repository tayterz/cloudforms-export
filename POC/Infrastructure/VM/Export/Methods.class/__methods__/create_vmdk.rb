...
def create_vmdk(user_name, store_id, vm_name, vm_id, vdisk_location)
  ...
  cmd = "cd /mnt/exports/#{store_id}; qemu-img convert -O vmdk images/#{vdisk_location} /mnt/exports/#{user_name}/#{vm_name}.vmdk"
...
vm.custom_set("Latest VMDK Export","https://#{$evm.root['miq_server'].hostname}/exports/#{user.name}/#{my_vm_name}.vmdk")
